...
static cocos2d::Size designResolutionSize = cocos2d::Size(DESIGN_WIDTH, DESIGN_HEIGHT);
...
bool AppDelegate::applicationDidFinishLaunching() {
    ...
    if(!glview) {
		...
		glview = GLViewImpl::createWithRect("MyGame", cocos2d::Rect(0, 0, designResolutionSize.width * 0.7, designResolutionSize.height * 0.7));
#else
